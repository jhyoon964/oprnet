...
from .. import backbones_2d, backbones_3d, dense_heads, multimodal_fusion_detector
from ..backbones_2d import map_to_bev
from ..backbones_3d import pfe, vfe
from ..model_utils import model_nms_utils, network_utils
from .. import auxilairy
...
class Detector2DTemplate(nn.Module):
    ...
    def build_img_backbone(self, model_info_dict):
        ...
        img_backbone_module = auxiliary.__all__[self.model_cfg.IMG_BACKBONE.NAME](
    ...
    def build_roi_head(self, model_info_dict):
        if self.model_cfg.get('ROI_HEAD', None) is None:
            return None, model_info_dict
        point_head_module = multimodal_fusion_detector.__all__[self.model_cfg.ROI_HEAD.NAME](
